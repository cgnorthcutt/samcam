"""Fast contracts for isolated relay recording replacement."""
...
class RepublishArchiveRecordingTests(unittest.TestCase):
    def test_maintenance_upload_uses_the_archive_binary_envelope(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            chunks = recording_chunks("camera-lab-repair-0001", recording)
            ...
            self.assertEqual(header["session_id"], "camera-lab-repair-0001")
    ...
    def test_maintenance_url_is_separate_from_the_live_worker_name(self) -> None:
        self.assertEqual(
            relay_websocket_url("Archive Repair", "https://relay.example.test"),
            "wss://relay.example.test/ws/worker/Archive%20Repair",
        )
    ...
    def test_original_variant_uses_the_distinct_durable_envelope(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            chunk = recording_chunks("camera-lab-repair-0001", recording, variant="original")[0]
    ...
    def test_only_relay_compatible_session_ids_are_accepted(self) -> None:
        self.assertEqual(validate_session_id("camera-lab-repair-0001"), "camera-lab-repair-0001")
